...
test('find helper is overridden', function(assert) {
  visit('/');
...
test('click helper works as expected', function(assert) {
  visit('/');
  click('one-link');
...
test('findWithAssert works as expected', function(assert) {
  visit('/');
